...
const Home = () => {
  return (
    ...
    <div>
        <button className='text-[#ffff] border-2 px-5 py-3 my-2 flex items-center hover:bg-orange-500'><Link to="portfolio" smooth={true} duration={500}>
                View Work
              </Link><HiArrowNarrowRight className='ml-2'/></button>
    </div>
    </div>
    </section>
  )
